"""
LoRA Fine-tuning for CaseHOLD Legal QA
Parameter-efficient fine-tuning using Low-Rank Adaptation (LoRA).
Only trains ~0.3M parameters (0.24% of total) by adding low-rank adapters.

Usage:
    python scripts/train_lora.py --output_dir results/lora --epochs 3
"""
...
def train(args):
    ...
    # Configure LoRA
    print(f"\nApplying LoRA with rank={args.lora_r}, alpha={args.lora_alpha}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="LoRA Fine-tuning for CaseHOLD")
    ...
    parser.add_argument('--output_dir', default='results/lora', type=str,
    ...
    parser.add_argument('--lora_r', default=8, type=int,
                        help='LoRA rank (low-rank dimension)')
